document.addEventListener("DOMContentLoaded", () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      answers: [
        "Caractéristiques, nombre, qualités et défauts",
  ...
  function showStep() {
    if (currentStep < steps.length) {
      ...
      gameQuestion.innerHTML = step.question;
