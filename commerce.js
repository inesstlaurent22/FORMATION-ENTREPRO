...
const steps = [
  ...
  { question:"Qui compose l’équipage ?", answers:["Capitaine et moussaillons","Capitaine seul","Toute la famille"], correct:0 },
...
document.getElementById("btnHint").onclick = () => {
  clueEl.textContent = "💡 Peu de concurrence ici.";
};
