document.addEventListener("DOMContentLoaded", () => {
  ...
  // 🔹 URL DU BACKGROUND DE communication.html
  const backgroundImage = "Communicationfond.PNG";

  // 🔹 Préchargement du background
  const bg = new Image();
  bg.src = backgroundImage;

  bg.onload = () => {
    console.log("✅ Background chargé, lancement du mini-jeu");
    startMiniGame();
  };

  bg.onerror = () => {
    console.warn("⚠️ Background non chargé, lancement forcé");
    startMiniGame();
  };
